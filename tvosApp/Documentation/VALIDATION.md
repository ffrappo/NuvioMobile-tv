...
- The simulator XCTest suite passed 50 tests with zero failures on destination `C88E5129-768F-4C58-8DF3-ADA7D514FBD6`. Log: `/tmp/nuvio-tests-2.log`. Deterministic URL-protocol tests verify concurrent catalog request coalescing plus cache clearing.
