...
- Home uses a large, ten-second rotating hero drawn from up to eight deduplicated catalog titles, and rotation stops when Reduce Motion is enabled.
...
- All 10,198 Swift source and test lines remain in files at or below 400 lines. The largest is `MPVPlayerController.swift` at 400 lines.
