...
- the current tvOS 27 simulator suite passed 51 tests with zero failures after the catalog, detail, source, player-control, playback-volume, and interruption corrections
